...
np.save("cls_features.npy", cls_features)
np.save("attention_scores.npy", np.array(all_attention_scores, dtype=object))

print("\nSaved:")
print(" - cls_features.npy")
print(" - attention_scores.npy")
